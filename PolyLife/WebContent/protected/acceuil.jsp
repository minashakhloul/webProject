...
<!--<form class="well span6 myClass" method="get" action="acceuil" id="cssAcceuil">-->
	<div id="header">
		...
		<!-- --><li><a href="profil.jsp"><%=prenom %> <%=nom %></a></li>
	...
	<div id="headcontentzone">
		...
		<h2>Evenement X</h2>
			<div class="illustration">
				<img src="http://dummyimage.com/200x150/000/fff" width="200px" height="150px"/>
			</div>
			<div class="text">
				<p>
				Ceci est un exemple d'information qui sera affiché<br/>
				Avec des infos qui la completerons
				</p>
			</div>
		</div>
	</div>
