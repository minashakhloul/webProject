...
public class ServletRegistration extends HttpServlet {
    ...
    public static final String homePage = "/protected/acceuil.jsp";
	    ...
	    public void userCreation(HttpServletRequest request) {
			String userType = request.getParameter( "userType" );
			switch(userType) {
				case "student": 	studentCreation(request);	break;
				case "exStudent": 	exStudentCreation(request);	break;
				case "professor":	professorCreation(request);	break;
			}
	    }
	    
	    public void studentCreation(HttpServletRequest request) {
	    ...
	    public void exStudentCreation(HttpServletRequest request) {
	    	String name = request.getParameter( "name" );
	    	String firstName = request.getParameter( "firstName" );
	    	String company = request.getParameter("company");
	    ...
	    public void professorCreation(HttpServletRequest request) {
	    	String name = request.getParameter( "name" );
	    	String firstName = request.getParameter( "firstName" );
	    	String emailAdress = request.getParameter( "emailAdress" );
	    	String passWord = request.getParameter( "passWord" );
		...
		public boolean studentExist(String emailAdress) {
	    ...
	    public int getIdStudentByEmail(String emailAdress) {
	    	int id = -1;
