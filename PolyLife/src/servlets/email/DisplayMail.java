...
public class DisplayMail extends HttpServlet {
	...
	public void displayEmails(HttpServletRequest request, HttpServletResponse response) throws IOException
	{
		...
		for (Email email : emailList) {
			if(email.isSeen()) 
				out.println("<tr id='mail"+ email.getID() +"' onClick='displayMailContent(\""+ email.getSubject() +"\" , \""+ email.getContent() +"\" , \""+ email.getFrom() +"\", \""+ email.getID() +"\")'><td>" + email.getFrom() + "</td><td>" + email.getSubject() + "</td></tr>");	
			else
				out.println("<tr style='font-weight: bold;' id='mail"+ email.getID() +"' onClick='displayMailContent(\""+ email.getSubject() +"\" , \""+ email.getContent() +"\" , \""+ email.getFrom() +"\", \""+ email.getID() +"\")'><td>" + email.getFrom() + "</td><td>" + email.getSubject() + "</td></tr>");	
		}
		out.println("</table>");
		out.println("</div>");
