...
<link type="text/css" rel="stylesheet"
	...
	<link type="text/css" rel="stylesheet"
	href="/PolyLife/inc/bootstrap.min.css" />
<link type="text/css" rel="stylesheet"
			...
			<div class="row">
				...
				<div class="span6" align="left">
					...
					<div id="eventResults">
						...
						<span> <strong class="strong"> Titre: </strong>${sessionScope.annoncement.getTitle()}
						</span> <br />
						<br /> <span> <strong class="strong"> Prix: </strong>
							${sessionScope.annoncement.getPrice()}
						</span> <br />
						<br />
				...
				<div class="span6" align="center">
					...
					<div class="controls">
						<img id="myImg"
							src="<%=request.getContextPath()%>/img/annoncements/${sessionScope.annoncement.getEventFilePath()}"
